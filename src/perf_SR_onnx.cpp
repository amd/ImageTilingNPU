...
int main(int argc, char** argv) {
    ...
    size_t output_image_width = static_cast<size_t>(FLAGS_image_width);
    size_t output_image_height = static_cast<size_t>(FLAGS_image_height);
    ...
    memset(input_buf.get(), 0, input_canvas_width * input_canvas_height * input_c);
    std::unique_ptr<char[]> output_buf(new char[output_canvas_width * output_canvas_height * output_c]);
    memset(output_buf.get(), 0, output_canvas_width * output_canvas_height * output_c);
